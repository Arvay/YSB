...
(function($){
	...
	Page.prototype.fillHtml=function(){
		...
		if(args.showPrev){
			if(args.current > 1){
				obj.append('<a href="javascript:;" class="prevPage"><img src="../static/images/page_left.png"/></a>');
			}else{
				obj.remove('.prevPage');
				obj.append('<span class="disabled"><img src="../static/images/page_left.png"/></span>');
			}
		}
		//中间页码
		if(args.current != 1){
		...
		if(args.showNext){
			if(args.current== args.pageCount||args.pageCount==1){
				obj.remove('.nextPage');
				obj.append('<span class="disabled"><img src="../static/images/page_right.png"/></span>');
			}else{
				obj.append('<a href="javascript:;" class="nextPage"><img src="../static/images/page_right.png"/></a>');
			}
		}
